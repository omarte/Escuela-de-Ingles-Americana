...
const mdPath = path.resolve(__dirname, '../../docs/curacion-docente/A1_Semanas_6_7.md')
...
const w6Rows = tableRows.slice(0, 74)
const w7Rows = tableRows.slice(74, 74 + 77)
...
console.log('🎉 Weeks 6 and 7 successfully integrated!')
