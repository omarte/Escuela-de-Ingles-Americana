...
const mdPath = path.resolve(__dirname, '../../docs/curacion-docente/A2_Semanas_5_6_7.md')
...
// A2 Week 6: 44 words
// A2 Week 7: 34 words
const w5Rows = tableRows.slice(0, 48)
const w6Rows = tableRows.slice(48, 48 + 44)
const w7Rows = tableRows.slice(48 + 44, 48 + 44 + 34)
