...
const mdPath = path.resolve(__dirname, '../../docs/curacion-docente/A2_Semanas_8_9_10.md')
...
// A2 Week 9: 44 words
// A2 Week 10: 39 words
const w8Rows = tableRows.slice(0, 46)
const w9Rows = tableRows.slice(46, 46 + 44)
const w10Rows = tableRows.slice(46 + 44, 46 + 44 + 39)
