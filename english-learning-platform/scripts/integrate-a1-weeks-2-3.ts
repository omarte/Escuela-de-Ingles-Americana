...
const mdPath = 'c:/Users/ozmar/Downloads/A1_Semanas_2_3.md'
...
const w2Rows = tableRows.slice(0, 88)
const w3Rows = tableRows.slice(88, 88 + 90)
...
function updateWeekFile(weekNum: number, rows: typeof tableRows, fileName: string) {
  ...
  rows.forEach((row, idx) => {
    // Find vocabulary item by index or word
...
console.log('🎉 Weeks 2 and 3 successfully integrated!')
