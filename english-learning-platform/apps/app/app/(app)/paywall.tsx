        ...
        {packages.length === 0 ? (
          <Card padding="lg" style={styles.emptyCard}>
            ...
            <Text style={styles.emptyText}>
              Los productos de suscripción ($9.99/mes con 7 días de prueba y $79.99 vitalicio) se están sincronizando con Google Play Console. Mientras tanto, puedes seguir aprendiendo con el Starter Deck inicial de 3 semanas.
            </Text>
          </Card>
        ) : (
          packages.map((pkg) => {
