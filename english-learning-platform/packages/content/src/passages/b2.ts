...
export const b2ReadingPassages: readonly ReadingPassage[] = [
  {
    ...
    wordMappings: [
      { en: 'paradox', es: 'paradoja', vocabularyId: 'voc_b2_paradox_005' },
      { en: 'ethical', es: 'ética', vocabularyId: 'voc_b2_ethical_109' },
      { en: 'scrutinize', es: 'escudriñar', vocabularyId: 'voc_b2_scrutinize_103' },
      { en: 'ambiguity', es: 'ambigüedad', vocabularyId: 'voc_b2_ambiguity_004' },
      { en: 'inherent', es: 'inherente', vocabularyId: 'voc_b2_inherent_015' },
      { en: 'figure out', es: 'descifrar', vocabularyId: 'voc_b2_figure-out_075' },
      { en: 'automation', es: 'automatización' },
      { en: 'unprecedented', es: 'sin precedentes', vocabularyId: 'voc_b2_unprecedented_111' },
      { en: 'implications', es: 'implicaciones', vocabularyId: 'voc_b2_implication_006' },
      { en: 'algorithms', es: 'algoritmos' },
    ],
  ...
  },
  {
    ...
    wordMappings: [
      { en: 'merger', es: 'fusión', vocabularyId: 'voc_b2_merger_039' },
      { en: 'leadership', es: 'liderazgo', vocabularyId: 'voc_b2_leadership_031' },
      { en: 'strategic', es: 'estratégico', vocabularyId: 'voc_b2_strategy_032' },
      { en: 'compliance', es: 'cumplimiento', vocabularyId: 'voc_b2_compliance_044' },
      { en: 'come up with', es: 'idear', vocabularyId: 'voc_b2_come-up-with_063' },
      { en: 'shareholder', es: 'accionistas', vocabularyId: 'voc_b2_shareholder_034' },
      { en: 'stakeholders', es: 'partes interesadas', vocabularyId: 'voc_b2_stakeholder_033' },
      { en: 'transparency', es: 'transparencia', vocabularyId: 'voc_b2_transparency_043' },
      { en: 'accountability', es: 'rendición de cuentas', vocabularyId: 'voc_b2_accountability_042' },
      { en: 'look forward to', es: 'esperan con ilusión', vocabularyId: 'voc_b2_look-forward-to_061' },
    ],
    verifiedBy: 'curator_editorial_team',
    verifiedAt: '2026-09-10',
    status: 'published',
